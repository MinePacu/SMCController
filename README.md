...
Use SwiftUI string literals for static user-facing labels, and add the same key to all three files. For runtime-formatted messages, use `L10n.string("key", arguments...)` from `SMCController/Support/L10n.swift`.
